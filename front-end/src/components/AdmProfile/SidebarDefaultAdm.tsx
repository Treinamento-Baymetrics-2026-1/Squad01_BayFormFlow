...
export const SidebarDefaultAdm = ({
  ...
  const location = useLocation(); // Hook para escutar qual página está renderizada em tempo real
      ...
      <div>
        ...
        >
          {!isCollapsed ? (
            ...
            /* Quando minimizada: Logo clicável que expande a barra */
            <button
              type="button"
          ...
          {/* O botão de colapsar agora só aparece se ela estiver aberta */}
          {!isCollapsed && (
            <button
              type="button"
